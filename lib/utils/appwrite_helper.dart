...
extension RealtimeMessageExt on RealtimeMessage {
  AppWriteCrudEvent get crudEvent =>
      AppWriteCrudEvent.values.byName(events.first.split('.').last);
}

enum AppWriteCrudEvent { create, read, update, delete }
...
class AppWriteHelper {
  ...
  static final permissions = <String>[
